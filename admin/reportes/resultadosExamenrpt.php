...
define("EW_REPORT_TABLE_VAR", "resultadosExamen", TRUE);
define("EW_REPORT_TABLE_SESSION_GROUP_PER_PAGE", "resultadosExamen_grpperpage", TRUE);
define("EW_REPORT_TABLE_SESSION_START_GROUP", "resultadosExamen_start", TRUE);
define("EW_REPORT_TABLE_SESSION_SEARCH", "resultadosExamen_search", TRUE);
define("EW_REPORT_TABLE_SESSION_CHILD_USER_ID", "resultadosExamen_childuserid", TRUE);
define("EW_REPORT_TABLE_SESSION_ORDER_BY", "resultadosExamen_orderby", TRUE);
...
Resultados Examen
<?php if (@$sExport == "") { ?>
&nbsp;&nbsp;<a href="resultadosExamenrpt.php?export=excel">Export to Excel</a>
<?php } ?>
<br /><br />
<?php if (@$sExport == "") { ?>
</div></td></tr>
...
<form action="resultadosExamenrpt.php" name="ewpagerform" id="ewpagerform" class="ewForm">
...
<!--first page button-->
	...
	<td><a href="resultadosExamenrpt.php?start=<?php echo $Pager->FirstButton->Start ?>"><img src="phprptimages/first.gif" alt="First" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="phprptimages/firstdisab.gif" alt="First" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($Pager->PrevButton->Enabled) { ?>
	<td><a href="resultadosExamenrpt.php?start=<?php echo $Pager->PrevButton->Start ?>"><img src="phprptimages/prev.gif" alt="Previous" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
...
<!--next page button-->
	...
	<td><a href="resultadosExamenrpt.php?start=<?php echo $Pager->NextButton->Start ?>"><img src="phprptimages/next.gif" alt="Next" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="phprptimages/nextdisab.gif" alt="Next" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($Pager->LastButton->Enabled) { ?>
	<td><a href="resultadosExamenrpt.php?start=<?php echo $Pager->LastButton->Start ?>"><img src="phprptimages/last.gif" alt="Last" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
...
function getSort()
{
	...
	if (strlen(@$_GET["cmd"]) > 0) {
		...
		if ($sCmd == "resetsort") {
			...
			$_SESSION["sort_resultadosExamen_NombreCompleto"] = "";
			$_SESSION["sort_resultadosExamen_NotaObtenida"] = "";
			$_SESSION["sort_resultadosExamen_Fecha"] = "";
		}
