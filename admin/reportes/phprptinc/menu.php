...
$RootMenu->AddMenuItem(7, "Descargas", "descargasctb.php", -1, TRUE);
$RootMenu->AddMenuItem(11, "Notas Obtenidas", "Notas_Obtenidassmry.php", -1, TRUE);
$RootMenu->AddMenuItem(15, "Usuarios", "Usuarios_smry.php", -1, TRUE);
$RootMenu->Render();
?>
  </p>
  <p>&nbsp;    </p>
