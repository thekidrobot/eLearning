...
define("EW_REPORT_CONN_HOST", "db2657.perfora.net", TRUE);
define("EW_REPORT_CONN_PORT", 3306, TRUE);
define("EW_REPORT_CONN_USER", "dbo345338034", TRUE);
define("EW_REPORT_CONN_PASS", "webtv123", TRUE);
define("EW_REPORT_CONN_DB", "db345338034", TRUE);
...
define("EW_REPORT_RANDOM_KEY", 'B#rWS5ruNRpDgecC', TRUE); // Random key for encryption
...
define("EW_REPORT_PROJECT_NAME", "reporte1_victor", TRUE); // Project Name
define("EW_REPORT_PROJECT_VAR", "reporte1_victor", TRUE); // Project Name
