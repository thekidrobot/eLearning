        ...
        <td class="body-text1" valign="top">
		  ...
		  ?>
			...
			extract($row);
			  ?> 
                    <tr bgcolor="white" >
                      <td valign="top" class="body-text1"><a href="admvideos.php?actualizar=<?=$Idvideo?>&<? if (isset($IdSubGrupo)){ echo "IdSubGrupo=".$IdSubGrupo; }else{ echo "IdGrupos=".$IdGrupos; }?>" style="color:red "><?=$UrlVideo?></a>				                </td>
					 ...
					 <a href="subirspeaker.php?IdVideo=<?=$Idvideo ?>" style="color:red" target="_blank">Subir</a>
					  ...
					  <td width="11%" valign="top" class="body-text1"><?=$estado?></td>
