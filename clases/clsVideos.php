...
//////////////////////////////////////////////////////////////////////////////////////////////////
function quitarVideos($Idvideo,$IdArchivo)
{
$link = mysql_connect($_SESSION["servidor"], $_SESSION["root"],$_SESSION["claveBD"]);
mysql_select_db($_SESSION["basededatos"], $link); 
$sql="delete from archivos_videos WHERE Idvideo=$Idvideo and IdArchivo = $IdArchivo";
...
function ConsultarMaterialApoyoVideo($filename)
{
$link = mysql_connect($_SESSION["servidor"], $_SESSION["root"],$_SESSION["claveBD"]);
mysql_select_db($_SESSION["basededatos"], $link); 
$sql="select * from videos WHERE Idvideo IN(select IdVideo from archivos_videos where NombreArchivo = '$filename')";
return $result = mysql_query($sql);
}


function BorrarMaterialApoyo($NomArchivo)
{
$link = mysql_connect($_SESSION["servidor"], $_SESSION["root"],$_SESSION["claveBD"]);
mysql_select_db($_SESSION["basededatos"], $link); 
$sql="delete from archivos_videos WHERE NombreArchivo='$NomArchivo'";
return $result = mysql_query($sql);
}
