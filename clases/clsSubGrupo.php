...
$sql="update modulos set Titulo='".$Titulo."',Calificacion=".$Calificacion.",CalificacionMinima=".$CalificacionMinima.",estado='".$estado."' where  IdModulo=".$IdModulo;
$result = mysql_query($sql);
}
//////////////////////////////////////////////////////////////////////////////////////////////////
...
$sql = "delete from preguntas where IdModulo= $IdModulo";
mysql_query($sql) or die('Invalid query: ' . mysql_error().' '.$sql);
...
//////////////////////////////////////////////////////////////////////////////////////////////////
function consultarResultadoUsuario($IdModulo,$IdUsuario)
{
  $link = mysql_connect($_SESSION["servidor"], $_SESSION["root"],$_SESSION["claveBD"]);
  mysql_select_db($_SESSION["basededatos"], $link); 
  $sql = "SELECT * FROM  resultadoexamen where IdModulo=$IdModulo and IdUsuario = $IdUsuario order by NotaObtenida asc";
  $result = mysql_query($sql, $link);
  return $result;
}

//////////////////////////////////////////////////////////////////////////////////////////////////
function consultarFechaAprobacion($IdModulo,$IdUsuario)
{
  $link = mysql_connect($_SESSION["servidor"], $_SESSION["root"],$_SESSION["claveBD"]);
  mysql_select_db($_SESSION["basededatos"], $link); 
  $sql = "SELECT DATE_FORMAT(Fecha,'%M %e, %Y') AS Fecha FROM resultadoexamen
          WHERE IdUsuario in(select IdUsuario from usuarios where Usuario = '$IdUsuario') 
          AND NotaObtenida >= NotaMinima 
