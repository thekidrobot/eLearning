...
<form id="form1" name="form1" method="post" action="<?php echo $editFormAction; ?>e&amp;VActivo=activo">
  ...
  <table width="464" border="0" align="center" cellpadding="1" bgcolor="#FFFFFF" class="bordes">
    ...
    <tr>
      <td valign="top" class="Estilo3" scope="col"><strong>Pa&iacute;s<span class="Estilo9">*</span></strong></td>
      <th colspan="2" valign="top" scope="col"><div align="left">
    ...
    <tr>
      <td valign="top" class="Estilo3" scope="col"><strong>Ciudad<span class="Estilo9">*</span></strong></td>
      <th colspan="2" valign="top" scope="col"><div align="left">
        <input name="Ciudad" type="text" class="Estilo3" id="Ciudad" size="50" value="<?php echo $_POST['Ciudad']; ?>" />
      </div></th>
    </tr>
    <tr>
      <th valign="top" class="Estilo3" scope="col"><div align="left" class="Estilo7">Email - Usuario<span class="Estilo9">*</span></div></th>
