...
<ul>
	<li>
		<h2>Menu</h2>
		<ul>
			<li class="current_page_item"><a href="../admin/admdeptos.php" target="carga">Departamentos</a></li>
			<li><a href="../admin/admusuarios.php" target="carga">Usuarios</a></li>
			<li><a href="../admin/admCategorias.php" target="carga">Categorias</a></li>
			<li><a href="../admin/admreporte.php" target="carga">Reportes Por Usuario</a></li>
			<li><a href="../admin/admreportevideo.php" target="carga">Reportes Por Video</a></li>
			<li><a href="../admin/admacceso.php" target="carga">Acceso</a></li>
			<li><a href="index.php" target="carga">Archivos</a></li>
