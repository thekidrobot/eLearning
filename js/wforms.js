...
// ------------------------------------------------------------------------------------------
   ...
   if(wFORMS) {
		...
		wFORMS.behaviors['validation'] = {
			...
			errMsg_required 	: "*Requerido.",
			errMsg_alpha 		: "Solo se permiten letras (a-z, A-Z). Los numeros no son permitido.",
			errMsg_email 		: "No es una valida direccion de e-mail.",
			errMsg_integer 		: "Por favor ingrese un numero entero.",
			errMsg_float 		: "Por favor ingrese un numero decimal(ex. 1.9).",
			errMsg_password 	: "Contraseña no segura. Su contraseña debe tener entre 4 y 12 caracteres de largo, use una combinacion de mayusculas y minusculas.",
			errMsg_alphanum 	: "Por favor utilize unicamente caracteres alfanumericos [a-z 0-9].",
			errMsg_date 		: "La fecha es invalida.",
			errMsg_notification : "%% error(s) detectedos. El formulario no se enviará.\nPor favor, chequea la información suministrada.",  // %% will be replaced by the actual number of errors.
			errMsg_custom		: "Por favor ingrese un valor valido.",
