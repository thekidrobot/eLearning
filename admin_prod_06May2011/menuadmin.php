	  ...
	  <table cellpadding="0" cellspacing="0" width="100%" height="100%">
	   ...
	   <tr>
		<td class="body-text1" background="imagenes/fondoPAGINA.jpg"  valign="middle" align="center">
	      <table>
		   <tr>
		    ...
		    <td class="body-text1" >
			 <a href="admdeptos.php" target="carga" class="tahoma_11_center" style="color:red">Departamentos</a>
			</td>
		    <td class="body-text1" >&nbsp;</td>
		    <td class="body-text1" >
			 <a href="admusuarios.php" target="carga" class="tahoma_11_center" style="color:red">Usuarios</a>
			</td>
		    <td class="body-text1" >&nbsp;</td>
		<!--    <td class="body-text1" >-->
		<!--	 <a href="admpermisosusuarios.php" target="carga" class="tahoma_11_center" style="color:red">Multiples Usuarios</a>-->
		<!--	</td>-->
		    <td class="body-text1" >&nbsp;</td>

		    <td class="body-text1" ><a href="admCategorias.php" target="carga" class="tahoma_11_center" style="color:red">Categorias</a> </td>
		...
		<td class="body-text1" >&nbsp;</td>
		    ...
		    <td class="body-text1" >&nbsp;</td>
		    <td class="body-text1" >
			 <a href="admacceso.php" target="carga" class="tahoma_11_center" style="color:red">Acceso</a>			</td>

		    <td class="body-text1" >&nbsp;</td>
		    <td class="body-text1" >
			 <a href="../apoyos/index.php" target="carga" class="tahoma_11_center" style="color:red">Archivos</a>			</td>
